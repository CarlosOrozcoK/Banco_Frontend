...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (isAuthenticated()) {
      setIsLoggedIn(true);
      navigate('/welcome'); // Cambiar a welcome en lugar de HomePage
    }
  }, [navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (result && !result.error && isAuthenticated()) {
      navigate("/welcome");
    }
  };
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-center">
            ...
            <p className="text-blue-100 mt-1">Inicia sesión en tu cuenta</p>
          </div>
