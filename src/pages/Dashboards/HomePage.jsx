            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white py-3 rounded-lg font-medium transition-all shadow-md hover:shadow-lg">
                    Solicitar ahora
                  </button>
                </div>
              </div>
            ...
            {investments.map((investment) => (
              <div key={investment.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900 text-white py-3 rounded-lg font-medium transition-all shadow-md hover:shadow-lg">
                    Invertir ahora
                  </button>
                </div>
              </div>
